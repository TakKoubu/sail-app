class SailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sail.save
        format.html { redirect_to sail_url(@sail), notice: "Sail was successfully created." }
  ...
  def update
    respond_to do |format|
      if @sail.update(sail_params)
        format.html { redirect_to sail_url(@sail), notice: "Sail was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sails_url, notice: "Sail was successfully destroyed." }
  ...
  private
    ...
    def sail_params
      params.require(:sail).permit(:content)
    end
end
